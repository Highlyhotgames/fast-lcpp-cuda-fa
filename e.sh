...
echo 'Qwen v3 models'
hf download --local-dir models/txt --max-workers 14 unsloth/Qwen3-1.7B-GGUF Qwen3-1.7B-UD-Q8_K_XL.gguf && df -h /
hf download --local-dir models/txt --max-workers 14 unsloth/Qwen3-4B-GGUF Qwen3-4B-UD-Q6_K_XL.gguf && df -h /
hf download --local-dir models/txt --max-workers 14 unsloth/Qwen3-4B-128K-GGUF Qwen3-4B-128K-UD-Q6_K_XL.gguf && df -h /
hf download --local-dir models/txt --max-workers 14 unsloth/DeepSeek-R1-0528-Qwen3-8B-GGUF DeepSeek-R1-0528-Qwen3-8B-UD-Q4_K_XL.gguf && df -h /
hf download --local-dir models/txt --max-workers 14 unsloth/Qwen3-8B-GGUF Qwen3-8B-UD-Q4_K_XL.gguf && df -h /
...
hf download --local-dir models/txt --max-workers 14 MaziyarPanahi/GLM-4.6V-Flash-GGUF GLM-4.6V-Flash.Q6_K.gguf && df -h /
echo 'Downloading vision models...'
echo 'Qwen3 VL'
hf download --local-dir models/vision --max-workers 14 unsloth/Qwen3-VL-2B-Thinking-GGUF Qwen3-VL-2B-Thinking-UD-Q8_K_XL.gguf && df -h /
hf download --local-dir models/vision --max-workers 14 unsloth/Qwen3-VL-2B-Instruct-GGUF Qwen3-VL-2B-Instruct-UD-Q8_K_XL.gguf && df -h /
hf download --local-dir models/vision --max-workers 14 unsloth/Qwen3-VL-4B-Instruct-GGUF Qwen3-VL-4B-Instruct-UD-Q8_K_XL.gguf && df -h /
